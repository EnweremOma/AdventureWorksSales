...
namespace AdventureWorksSales.Core.Concrete
{
    ...
    {
        protected AdventureWorksSalesEntities _context;

        public GenericRepostory()
        {
            this._context = new AdventureWorksSalesEntities();
        }
        ...
        /// 
        public GenericRepostory(AdventureWorksSalesEntities context)
        {
            _context = context;
        }
        /// <summary>
